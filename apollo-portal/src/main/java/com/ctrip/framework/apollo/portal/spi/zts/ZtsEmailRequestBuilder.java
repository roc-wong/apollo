...
public class ZtsEmailRequestBuilder {

  private static final Logger logger = LoggerFactory.getLogger(ZtsEmailRequestBuilder.class);
  ...
  private static Method setBodyHtml;
  ...
  public void init() {
    try {
      sendEmailRequestClazz = Class.forName("com.zts.framework.email.client.SendEmailRequest");
      ...
      setBodyHtml = sendEmailRequestClazz.getMethod("setBodyHtml", Boolean.class);
  ...
  private Object createBasicEmailRequest() throws Exception {
    ...
    setBodyHtml.invoke(request, true);
